...
function normalizePath (pageName, pagePath, basePath = '/') {
...
class Router {
  ...
  addRoute (route, pageTemplate) {
    ...
    const normalizedPath = normalizePath(pageName, pagePath, this.basePath)
